...
class MyPaginator
{
    ...
    public function link()
    {
        ...
        $result .= '<li classs="page-item' . $prev . '"><a class="page-link" href="' . $this->paginator->previousPageUrl() . '">←前のページ</a></li>';
        $result .= '<li class="page-item disabled"><a class="page-link">' . $this->paginator->currentPage() . '</a></li>';
        $result .= '<li classs="page-item' . $next . '"><a class="page-link" href="' . $this->paginator->nextPageUrl() . '">次のページ→</a></li>';
        $result .= '</ul>';
